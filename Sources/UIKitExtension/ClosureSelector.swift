...
public class ClosureSelector<T> {
    ...
    @objc func target(_ parm: AnyObject) {
...
public class ClosureNotification<T> {
    ...
    @objc func target(_ notification: Notification) {
...
extension NSObjectProtocol where Self: UIControl {
    @discardableResult
    public func addTarget(forControlEvents controlEvents: UIControl.Event, withClosure closure: @escaping (Self) -> Void) -> Self {
    ...
    @discardableResult
    public func addTarget<Value>(forControlEvents controlEvents: UIControl.Event, keyPath: KeyPath<Self, Value>, withClosure closure: @escaping (Value) -> Void) -> Self {
    ...
    @discardableResult
    public func bindTarget<T, Value>(to object: T, forControlEvents controlEvents: UIControl.Event, withClosure closure: @escaping (T, Value) -> Void) -> Self {
    ...
    @discardableResult
    public func bindTarget<T, Value>(to object: T, forControlEvents controlEvents: UIControl.Event, keyPath: KeyPath<Self, Value>, withClosure closure: @escaping (T, Value) -> Void) -> Self {
...
extension NSObjectProtocol where Self: UIBarButtonItem {
    public func addAction(_ closure: @escaping (Self) -> Void) {
        let closureSelector = ClosureSelector<Self>(closure)
...
extension NSObjectProtocol where Self: UITextView {
    public func bindTextDidChange<Value, Target: AnyObject>(_ sourceKeyPath: KeyPath<Self, Value>,
                                                            to target: Target,
    ...
    public func bindTextDidChangeMap<Value, NewValue, Target: AnyObject>(_ sourceKeyPath: KeyPath<Self, Value>,
                                                                         to target: Target,
    ...
    public func textDidChange(_ closure: @escaping (Self) -> Void) {
    ...
    public func textDidChange<Value>(_ keyPath: KeyPath<Self, Value>,
    ...
    public func textDidEndEditing(_ closure: @escaping (Self) -> Void) {
    ...
    public func textDidEndEditing<Value>(_ keyPath: KeyPath<Self, Value>,
                                         closure: @escaping (Value) -> Void) {
    ...
    public func textDidBeginEditing(_ closure: @escaping (Self) -> Void) {
    ...
    public func textDidBeginEditing<Value>(_ keyPath: KeyPath<Self, Value>,
                                           closure: @escaping (Value) -> Void) {
