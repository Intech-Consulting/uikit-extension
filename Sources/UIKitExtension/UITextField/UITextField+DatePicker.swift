...
//  Extensions
//
//  Created by BENSALAH on 24/05/2019.
...
extension UITextField {
    ...
    @discardableResult
    public func resignFirstResponderPicker() -> Bool {
    ...
    public func becomeFirstResponderPicker() -> Bool {
...
extension NSObjectProtocol where Self: UITextField {
    ...
    @discardableResult
    public func addTargetInputViewDatePicker(date: Date = Date(), closure: @escaping (Self) -> Void) -> Self {
    ...
    /// self.myTextField.inputView as? UIDatePicker
    @discardableResult
    public func addTargetInputViewTimerPicker(timer: TimeInterval = 0.0, closure: @escaping (Self) -> Void) -> Self {
        let closureSelector = ClosureSelectorTarget<Self>(bind: self, completion: closure)
        objc_setAssociatedObject(self, &handleDatePicker, closureSelector, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
